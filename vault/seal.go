...
type SealConfig struct {
	...
	// KeyIdentifierNames are the comma-separated human readable names to be
	// associated with the key identifiers. If provided, the number of names
	// should match the avlue of 'SecretThreshold'
...
func (s *SealConfig) Clone() *SealConfig {
	ret := &SealConfig{
		...
		KeyIdentifierNames: s.KeyIdentifierNames,
	}
	if len(s.PGPKeys) > 0 {
